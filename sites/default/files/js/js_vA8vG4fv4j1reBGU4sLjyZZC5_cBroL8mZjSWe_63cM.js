...
jQuery(document).ready(function($){
    ...
    var $toggle = $(".toggle");
    var $rare = $("#block-skillsblock .field--name-field-paragraphs, #block-skillsblock .field--name-field-paragraphs .field__item, #block-numbersstats .field--name-field-paragraphs .field__item, #block-numbersstats .field--name-field-paragraphs, .field--name-field-button a");
